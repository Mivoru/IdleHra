        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MiningMonolithLevel = table.Column<int>(type: "integer", nullable: false),
                    MiningMonolithProgress = table.Column<int>(type: "integer", nullable: false),
                    WoodcuttingMonolithLevel = table.Column<int>(type: "integer", nullable: false),
                    WoodcuttingMonolithProgress = table.Column<int>(type: "integer", nullable: false),
                    GuildMMR = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "historical_market_archives",
                columns: table => new
                {
                    ...
                    ExecutionPrice = table.Column<long>(type: "bigint", nullable: false),
                    FeeBurned = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    ExecutionTimestampEpoch = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_historical_market_archives", x => x.ArchiveId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgeTicks = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastLogoutTimestamp = table.Column<long>(type: "bigint", nullable: false),
                    AccumulatedTimeBankSeconds = table.Column<int>(type: "integer", nullable: false),
                    GuildId = table.Column<long>(type: "bigint", nullable: false),
                    ActiveOffensivePotionId = table.Column<int>(type: "integer", nullable: false),
                    OffensivePotionDurationMs = table.Column<int>(type: "integer", nullable: false),
                    ActiveDefensivePotionId = table.Column<int>(type: "integer", nullable: false),
                    DefensivePotionDurationMs = table.Column<int>(type: "integer", nullable: false),
                    PremiumDiamonds = table.Column<int>(type: "integer", nullable: false),
                    Quarantine_Active = table.Column<bool>(type: "boolean", nullable: false),
                    IsQuarantined = table.Column<bool>(type: "boolean", nullable: false),
                    LogicEpochCounter = table.Column<long>(type: "bigint", nullable: false),
                    BankedChronoSeconds = table.Column<double>(type: "double precision", nullable: false),
                    IsChronoAccelerating = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
