...
namespace FolkIdle.Server.Engine
{
    public static class ClientCommandValidator
    {
        ...
        // Modul: RETIRED with the four active skills. Kept as a pass-through
        // rather than deleted because the tick's command loop still names it,
        // and the two opcodes it guarded are now ignored rather than rejected -
        // a stale client sending them is an old bundle, not an attack. See
        // SkillTreeRegistry for what replaced the skills.
